...
namespace PolygonSample
{
    public class Function
    {
        ...
        private UrlModelStore<PolygonSampleInputs> store;

        public async Task<PolygonSampleOutputs> Handler(PolygonSampleInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<PolygonSampleInputs>();
            }
            

            var l = new InvocationWrapper<PolygonSampleInputs,PolygonSampleOutputs> (store, PolygonSample.Execute);
